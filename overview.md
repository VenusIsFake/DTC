...
* **Status:** live; DB schema **v2.2** applied (v2: FK indexes, RLS init-plan fix, RSVP count cache, realtime publication, gallery table + seed · v2.2: mandate-member photos + profile links, `supabase/migrations/` dir). Console production-readiness sweep shipped 2026-08-31/09-01 — see `docs/platform/production-readiness.md`.
