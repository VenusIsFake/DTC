...
import { ArrowRight, Play, Radio, Calendar, Eye, Sparkles } from "lucide-react";
  ...
  return (
    <section className="px-4 sm:px-6 lg:px-8 pt-4 sm:pt-8 pb-0">
      <div className="max-w-6xl mx-auto space-y-6 sm:space-y-8">
        {/* Editorial Brand Intro & "DTC Presents To You" Eyebrow */}
        <div className="space-y-3 sm:space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[#DCD7CB]/60 pb-3">
            <p className="inline-flex items-center gap-2 text-[11px] sm:text-xs font-bold tracking-[0.2em] uppercase text-[#755B18]">
              <Sparkles className="w-3.5 h-3.5 text-[#D4AF37]" />
              <span>DTC Presents to You</span>
              <span className="text-[#DCD7CB]">·</span>
              <span className="text-[#5C6672] font-semibold">FMDC Casablanca</span>
            </p>
            <span className="text-[10px] sm:text-[11px] font-semibold uppercase tracking-wider text-[#5C6672] hidden sm:inline">
              Saison 2025–2026
            </span>
          </div>

          <div className="space-y-1.5 sm:space-y-2">
            <h1 className="font-heading font-semibold text-4xl sm:text-6xl lg:text-[4.25rem] text-[#16233A] tracking-tight leading-[1.05]">
              Dentalk <span className="text-[#755B18]">Club</span>
            </h1>

            <p className="font-heading italic text-base sm:text-2xl text-[#3D4A58]">
              &laquo;&nbsp;{siteConfig.tagline}&nbsp;&raquo;
            </p>
          </div>
        </div>

        {/* Featured Dernière Sortie Spotlight Card */}
        {featuredEpisode && (
