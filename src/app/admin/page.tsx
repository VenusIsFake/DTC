  ...
  return (
    <div className="pt-10 sm:pt-14 pb-10 sm:pb-20 px-4 sm:px-6 max-w-xl mx-auto">
      <div className="glass-card rounded-lg border border-dtc-line/40 p-8 sm:p-12 text-center space-y-4">
        ...
        <h1 className="text-xl sm:text-2xl font-heading font-semibold text-dtc-ink">Accès refusé</h1>
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-full text-xs font-bold border border-dtc-gold/50 text-dtc-gold hover:bg-dtc-gold/10 transition-all"
        >
