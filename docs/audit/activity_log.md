...
- **Retour Venus (n°3) :** bouton suppression candidatures était icône seule (🏬 manqué) → remplacé par bouton étiqueté rouge « Supprimer » à côté du sélecteur de statut (confirm irréversible inchangé). Déployé.
