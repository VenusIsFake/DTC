...
graph TD
    ...
    PRES["<b>El Guerraoui Hatim</b><br/>Président"]
    
    VP1["<b>EL Khabbouli Saad</b><br/>Vice-Président"]
    VP2["<b>Saber Maryam</b><br/>Vice-Présidente"]
    
    PRES --> VP1
    PRES --> VP2
    
    %% Core Administration
    SG["<b>Jei Aya</b><br/>Secrétaire Générale"]
    CP["<b>Abla Douaae</b><br/>Chef de Projet"]
    TR["<b>Ettallab Elhoussein</b><br/>Trésorier"]
    
    PRES --> SG
    PRES --> CP
    PRES --> TR
    
    %% Operational Directors & Department Heads
    DA["<b>Essaghir Anas</b><br/>Directeur Artistique"]
    RM["<b>El Kinani Yassir</b><br/>Responsable Média"]
    RL["<b>Mrabet Zyad</b><br/>Responsable Logistique"]
    
    PRES --> DA
    PRES --> RM
    PRES --> RL
    
    %% Linguistic Debate Sections
    SA["<b>Jawadi Salwa</b><br/>Responsable Section Anglaise (ANG)"]
    SF["<b>Rouadha Ihssane</b><br/>Responsable Section Française (FR)"]
    SAR["<b>Ouagague Hafsa</b><br/>Responsable Section Arabe (AR)"]
